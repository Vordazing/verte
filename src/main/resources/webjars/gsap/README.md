...
```javascript
// typical import
import gsap from "webjars/gsap/types/index";

// get other plugins:
import ScrollTrigger from "webjars/gsap/ScrollTrigger";
import Flip from "webjars/gsap/Flip";
import Draggable from "webjars/gsap/Draggable";

// or all tools are exported from the "all" file (excluding members-only plugins):
import {gsap, ScrollTrigger, Draggable, MotionPathPlugin} from "webjars/gsap/all";
